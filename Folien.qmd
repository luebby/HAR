...
<!-- Wichtig!!! Einmalig im Verzteichnis vorher im Terminal laufen lassen! -->
...
Bootvtlg <- do(1000) * prop( ~ fehl, success = "Ja",
                             resample(Regeln))
...
Nullvtlg <- do(1000) * rflip(n = nrow(Regeln))
...
- **T** (thoughtful): Beachte und bedenke die Umstände, was ist das Ziel und der Kontext, wie ist der Prozess, wie lautet das Modell, welche Annahmen und Vorrausetzungen hat es? [:ballot_box_with_check:]{.green}
